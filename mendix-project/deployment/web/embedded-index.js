import { startEmbeddedApp, validateArguments } from "mendix";

export function render(domNode, configuration) {
    validateArguments(domNode, configuration);
    return startEmbeddedApp({
        "languages": [
                "en_US"
        ],
        "systemTexts": {
        ...
        rootElement: domNode,
        baseUrl: configuration.remoteUrl,
